          ...
          <CCard>
            ...
            <CCardBody>
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
               <CFormGroup row>
                  <CLabel col md={3}>Select the Sub Category Image</CLabel>
                  <CCol xs="9" md="9">
                ...
                <CFormGroup row>
				 ...
				 <CFormGroup row>
				  ...
				  <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="select">Enter SubCategory Name</CLabel>
                  </CCol>
                  <CCol xs="9" md="9">
                    <CInput id="text-input" name="text-input" placeholder="SubCategory Name" />
