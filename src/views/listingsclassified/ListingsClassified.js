        ...
        <CCol xs="12" md="12">
          <CCard>
            ...
            <CCardBody>
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
			   ...
			   <CFormGroup row>
				 ...
				 <CFormGroup row>
                  <CCol md="3"><CLabel>Enable Good 'Til Canceled</CLabel></CCol>
                  <CCol md="9">
                     <CSwitch
                      className="mr-1"
                      color="info"
            ...
            <CCardFooter className="text-center">
              <CButton type="submit" size="sm" color="primary"><CIcon name="cil-scrubber" /> Save Configuration</CButton>
...
export default ListingsClassified
