          ...
          Generate Purchase Order
			...
			<CCardBody>
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                ...
                <CCol xs="4">
                  <CFormGroup>
                    <CLabel htmlFor="first">PO No</CLabel>
                    <CInput id="first" placeholder="PO Number" />
                  </CFormGroup>
                </CCol>
                <CCol xs="4">
                  <CFormGroup>
                    <CLabel htmlFor="last">PO Date</CLabel>
                   <CInput type="date" id="date-input" name="date-input" placeholder="date" />
                  </CFormGroup>
                </CCol>
				<CCol xs="4">
                  <CFormGroup>
                    <CLabel htmlFor="last">Delivery Date</CLabel>
                   <CInput type="date" id="date-input" name="date-input" placeholder="date" />
                  </CFormGroup>
                </CCol>
              </CFormGroup>
                ...
                <CCol xs="6">
                  <CFormGroup variant="custom-checkbox" inline>
                      ...
                      <CLabel variant="custom-checkbox" htmlFor="inline-checkbox2">Add GST</CLabel>
                    </CFormGroup>
                </CCol>
              </CFormGroup>
	   ...
	   <CCol xs="12" md="6">
        ...
        <CCol xs="12" md="6">
          ...
          <CFormGroup  inline>
                      ...
                      <CLabel >Delivery Location</CLabel>
