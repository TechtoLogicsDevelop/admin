    ...
    <>
      ...
      <CRow>
        <CCol>
          <CCard>
            <CCardHeader>
          Order Status : On Route / In Transit
            </CCardHeader>
             ...
             <CButton size="sm" className="btn-twitter btn-brand mr-1 mb-1"><span className="mfs-2">Update Status</span></CButton>
              <CButton size="sm" className="btn-vimeo btn-brand mr-1 mb-1"><span className="mfs-2">Cancel</span></CButton>
                ...
                <CFormGroup >
                  ...
                  <CCol xs="6" md="6">
                    <CSelect custom name="select" id="select">
                      <option value="0">Select Update Order Status </option>
                      <option value="1">Picked up by Driver</option>
                      <option value="2">On Route / In Transit</option>
