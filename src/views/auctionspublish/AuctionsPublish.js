            ...
            <CCardBody>
			  ...
			  <hr/>
			   ...
			   <CFormGroup row className="my-0">
                ...
                <CCol xs="4">
				 ...
				 <CCol xs="4">
                  <CFormGroup>
                    <CLabel htmlFor="select">Select  Location *</CLabel>
                     <CSelect custom name="select" id="select">
                ...
                <CCol xs="3">
				 ...
				 <CCol xs="3">
                  <CFormGroup>
                    <CLabel htmlFor="first">For A Cause</CLabel>
                    <CInput id="first" placeholder="For A Cause" />
                  </CFormGroup>
                </CCol>
                <CCol xs="3">
                  <CFormGroup>
			  ...
			  <hr/>
			   <CFormGroup row className="my-0">
                ...
                <CCol xs="2">
                  <CFormGroup>
                    <CLabel htmlFor="first">Auction Start Date</CLabel>
                    <CInput type="date" id="date-input" name="date-input" placeholder="date" />
                  </CFormGroup>
                </CCol>
                <CCol xs="2">
                  <CFormGroup>
                    <CLabel htmlFor="first">Auction End Date</CLabel>
                    <CInput type="date" id="date-input" name="date-input" placeholder="date" />
                  </CFormGroup>
                </CCol>
				<CCol xs="2">
                  <CFormGroup>
                    ...
                    <CInput id="first" placeholder=" Start Time" />
                  </CFormGroup>
                </CCol>
				 <CCol xs="2">
                  <CFormGroup>
			  ...
			  <hr/>
			   ...
			   <CFormGroup row className="my-0">
                ...
                <CCol xs="2">
                  <CFormGroup>
                    <CLabel htmlFor="first">Base Price</CLabel>
                    <CInput id="first" placeholder="Base Price" />
                  </CFormGroup>
                </CCol>
                <CCol xs="2">
                  <CFormGroup>
                    <CLabel htmlFor="last">Reserve Price </CLabel>
                     <CInput id="first" placeholder="Reserve Price" />
                  </CFormGroup>
                </CCol>
				 <CCol xs="2">
                  <CFormGroup>
...
export default AuctionsPublish
