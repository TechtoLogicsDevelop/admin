              ...
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                ...
                <CFormGroup row>
				 ...
				 <CFormGroup row>
				  ...
				  <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="select">Child Sub-Module</CLabel>
                  </CCol>
                  <CCol xs="9" md="9">
                    <CInput id="text-input" name="text-input" placeholder="Child Sub-Module" />
...
export default AddChildSubModule
